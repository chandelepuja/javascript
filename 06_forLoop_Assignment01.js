console.log(`*****WAP to print number from 5 to 15 by incrementing by 1*****`);
for (let index = 5; index <=15; index++) {
    console.log(index);
    
}
console.log(`*****WAP to print number from 50 to 40 by decrementing by 1*****`);
...
console.log(`*** to print table of 10 in reverse order like-->100 90 80...10***`);
